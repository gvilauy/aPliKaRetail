...
/** Generated Interface for UY_RT_Ticket_LineTarjeta
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC
 */
public interface I_UY_RT_Ticket_LineTarjeta 
{

    /** TableName=UY_RT_Ticket_LineTarjeta */
    public static final String Table_Name = "UY_RT_Ticket_LineTarjeta";
    ...
    /** Column name cuotastarjetacredito */
    public static final String COLUMNNAME_cuotastarjetacredito = "cuotastarjetacredito";
    ...
    /** Column name NroComercio */
    public static final String COLUMNNAME_NroComercio = "NroComercio";
    ...
    /** Column name numautorizaciontjtacred */
    public static final String COLUMNNAME_numautorizaciontjtacred = "numautorizaciontjtacred";
    ...
    public static final String COLUMNNAME_numerotarjetacredito = "numerotarjetacredito";
    ...
    /** Column name SiEsDebitoCredito */
    public static final String COLUMNNAME_SiEsDebitoCredito = "SiEsDebitoCredito";
    ...
    public static final String COLUMNNAME_tipotarjetacredito = "tipotarjetacredito";
    ...
    /** Column name UY_RT_Ticket_LineTarjeta_ID */
    public static final String COLUMNNAME_UY_RT_Ticket_LineTarjeta_ID = "UY_RT_Ticket_LineTarjeta_ID";
