...
/** Generated Model for UY_RT_Ticket_LineCtaCte
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_Ticket_LineCtaCte extends PO implements I_UY_RT_Ticket_LineCtaCte, I_Persistent 
{
    ...
    public X_UY_RT_Ticket_LineCtaCte (Properties ctx, int UY_RT_Ticket_LineCtaCte_ID, String trxName)
    {
      super (ctx, UY_RT_Ticket_LineCtaCte_ID, trxName);
      /** if (UY_RT_Ticket_LineCtaCte_ID == 0)
        {
			setUY_RT_Ticket_LineCtaCte_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_RT_Ticket_LineCtaCte (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_Ticket_LineCtaCte[")
	...
	/** Set UY_RT_Ticket_LineCtaCte.
		@param UY_RT_Ticket_LineCtaCte_ID UY_RT_Ticket_LineCtaCte	  */
	public void setUY_RT_Ticket_LineCtaCte_ID (int UY_RT_Ticket_LineCtaCte_ID)
	{
		if (UY_RT_Ticket_LineCtaCte_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_Ticket_LineCtaCte_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_Ticket_LineCtaCte_ID, Integer.valueOf(UY_RT_Ticket_LineCtaCte_ID));
	}

	/** Get UY_RT_Ticket_LineCtaCte.
		@return UY_RT_Ticket_LineCtaCte	  */
	public int getUY_RT_Ticket_LineCtaCte_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_RT_Ticket_LineCtaCte_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
