...
/** Generated Model for UY_RT_Ticket_LineEfectivo
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_Ticket_LineEfectivo extends PO implements I_UY_RT_Ticket_LineEfectivo, I_Persistent 
{
    ...
    public X_UY_RT_Ticket_LineEfectivo (Properties ctx, int UY_RT_Ticket_LineEfectivo_ID, String trxName)
    {
      super (ctx, UY_RT_Ticket_LineEfectivo_ID, trxName);
      /** if (UY_RT_Ticket_LineEfectivo_ID == 0)
        {
			setUY_RT_Ticket_LineEfectivo_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_RT_Ticket_LineEfectivo (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_Ticket_LineEfectivo[")
	...
	/** Set UY_RT_Ticket_LineEfectivo.
		@param UY_RT_Ticket_LineEfectivo_ID UY_RT_Ticket_LineEfectivo	  */
	public void setUY_RT_Ticket_LineEfectivo_ID (int UY_RT_Ticket_LineEfectivo_ID)
	{
		if (UY_RT_Ticket_LineEfectivo_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_Ticket_LineEfectivo_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_Ticket_LineEfectivo_ID, Integer.valueOf(UY_RT_Ticket_LineEfectivo_ID));
	}

	/** Get UY_RT_Ticket_LineEfectivo.
		@return UY_RT_Ticket_LineEfectivo	  */
	public int getUY_RT_Ticket_LineEfectivo_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_RT_Ticket_LineEfectivo_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
