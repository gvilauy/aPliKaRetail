...
/** Generated Model for UY_RT_Ticket_LinePagoServ
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_Ticket_LinePagoServ extends PO implements I_UY_RT_Ticket_LinePagoServ, I_Persistent 
{
    ...
    public X_UY_RT_Ticket_LinePagoServ (Properties ctx, int UY_RT_Ticket_LinePagoServ_ID, String trxName)
    {
      super (ctx, UY_RT_Ticket_LinePagoServ_ID, trxName);
      /** if (UY_RT_Ticket_LinePagoServ_ID == 0)
        {
			setUY_RT_Ticket_LinePagoServ_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_RT_Ticket_LinePagoServ (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_Ticket_LinePagoServ[")
	...
	/** Set UY_RT_Ticket_LinePagoServ.
		@param UY_RT_Ticket_LinePagoServ_ID UY_RT_Ticket_LinePagoServ	  */
	public void setUY_RT_Ticket_LinePagoServ_ID (int UY_RT_Ticket_LinePagoServ_ID)
	{
		if (UY_RT_Ticket_LinePagoServ_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_Ticket_LinePagoServ_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_Ticket_LinePagoServ_ID, Integer.valueOf(UY_RT_Ticket_LinePagoServ_ID));
	}

	/** Get UY_RT_Ticket_LinePagoServ.
		@return UY_RT_Ticket_LinePagoServ	  */
	public int getUY_RT_Ticket_LinePagoServ_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_RT_Ticket_LinePagoServ_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
