...
/** Generated Model for UY_RT_Ticket_LineRetiro
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_Ticket_LineRetiro extends PO implements I_UY_RT_Ticket_LineRetiro, I_Persistent 
{
    ...
    public X_UY_RT_Ticket_LineRetiro (Properties ctx, int UY_RT_Ticket_LineRetiro_ID, String trxName)
    {
      super (ctx, UY_RT_Ticket_LineRetiro_ID, trxName);
      /** if (UY_RT_Ticket_LineRetiro_ID == 0)
        {
			setUY_RT_Ticket_LineRetiro_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UY_RT_Ticket_LineRetiro (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_Ticket_LineRetiro[")
	...
	/** Set montoretiro.
		@param montoretiro montoretiro	  */
	public void setmontoretiro (BigDecimal montoretiro)
	{
		set_Value (COLUMNNAME_montoretiro, montoretiro);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_montoretiro);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set UY_RT_Ticket_LineRetiro.
		@param UY_RT_Ticket_LineRetiro_ID UY_RT_Ticket_LineRetiro	  */
	public void setUY_RT_Ticket_LineRetiro_ID (int UY_RT_Ticket_LineRetiro_ID)
	{
		if (UY_RT_Ticket_LineRetiro_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_Ticket_LineRetiro_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_Ticket_LineRetiro_ID, Integer.valueOf(UY_RT_Ticket_LineRetiro_ID));
	}

	/** Get UY_RT_Ticket_LineRetiro.
		@return UY_RT_Ticket_LineRetiro	  */
	public int getUY_RT_Ticket_LineRetiro_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UY_RT_Ticket_LineRetiro_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
