...
/** Generated Model for UY_RT_TransactionReport
 *  @author Adempiere (generated) 
 *  @version Release 3.7.1RC - $Id$ */
public class X_UY_RT_TransactionReport extends PO implements I_UY_RT_TransactionReport, I_Persistent 
{
    ...
    public X_UY_RT_TransactionReport (Properties ctx, int UY_RT_TransactionReport_ID, String trxName)
    {
      super (ctx, UY_RT_TransactionReport_ID, trxName);
      /** if (UY_RT_TransactionReport_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UY_RT_TransactionReport (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UY_RT_TransactionReport[")
	...
	public void setUY_RT_TransactionReport_ID (int UY_RT_TransactionReport_ID)
	{
		if (UY_RT_TransactionReport_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UY_RT_TransactionReport_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UY_RT_TransactionReport_ID, Integer.valueOf(UY_RT_TransactionReport_ID));
	}
