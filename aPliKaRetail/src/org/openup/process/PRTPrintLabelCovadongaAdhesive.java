...
import org.openup.util.printlabels.PrintLabelCovadongaAdhesive;
 ...
 *
 */
public class PRTPrintLabelCovadongaAdhesive extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		PrintLabelCovadongaAdhesive pl = new PrintLabelCovadongaAdhesive(this.producto, this.precio, this.upc, this.quantity, this.getAD_Client_ID());
		pl.print();
		return "OK";
	}
