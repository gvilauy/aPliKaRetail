...
import org.openup.util.printlabels.PrintLabelCovadongaGondola;
 ...
 *
 */
public class PRTPrintLabelCovadongaGondola extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		PrintLabelCovadongaGondola pl = new PrintLabelCovadongaGondola(this.producto, this.precio, this.upc, this.quantity, this.getAD_Client_ID());
		pl.print();
		return "OK";
	}
