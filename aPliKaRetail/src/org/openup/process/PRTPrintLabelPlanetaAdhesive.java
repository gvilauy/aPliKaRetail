...
import org.openup.util.printlabels.PrintLabelPlanetaAdhesive;
 ...
 *
 */
public class PRTPrintLabelPlanetaAdhesive extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		PrintLabelPlanetaAdhesive pl = new PrintLabelPlanetaAdhesive(this.producto, this.precio, this.upc, this.quantity, this.getAD_Client_ID());
		pl.print();
		return "OK";
	}
